...
const steps = [
  ...
  {
        label: 'Visualization',
        description: `This macrophase represents the models generated by the architectural
                    recovery stage in graphical views so that users can better understand the
